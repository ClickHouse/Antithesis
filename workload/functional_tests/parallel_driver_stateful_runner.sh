...
ln -s /tests/clickhouse-test /usr/bin/clickhouse-test

# shellcheck disable=SC1091
source /tests/docker_scripts/utils.lib

#export CLICKHOUSE_CLIENT "clickhouse://clickhouse-01:9000"
...
# /tests/docker_scripts/setup_minio.sh stateful
...
counter=0
until clickhouse-client clickhouse://clickhouse-01:9000 --query "SELECT 1"
do
    if [ "$counter" -gt 120 ]
    then
        echo "Cannot start clickhouse-server"
...
echo "Creating databases for stateful tests"

clickhouse-client clickhouse://clickhouse-01:9000 --query "SHOW DATABASES"
clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE DATABASE datasets"
clickhouse-client clickhouse://clickhouse-01:9000 < /tests/docker_scripts/create.sql
clickhouse-client clickhouse://clickhouse-01:9000 --query "SHOW TABLES FROM datasets"

if [[ -n "$USE_DATABASE_REPLICATED" ]] && [[ "$USE_DATABASE_REPLICATED" -eq 1 ]]; then
    clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE DATABASE test ON CLUSTER 'test_cluster_database_replicated'
        ENGINE=Replicated('/test/clickhouse/db/test', '{shard}', '{replica}')"

    clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE TABLE test.hits AS datasets.hits_v1"
    clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE TABLE test.visits AS datasets.visits_v1"

    clickhouse-client clickhouse://clickhouse-01:9000 --max_memory_usage 10G --query "INSERT INTO test.hits SELECT * FROM datasets.hits_v1"
    clickhouse-client clickhouse://clickhouse-01:9000 --max_memory_usage 10G --query "INSERT INTO test.visits SELECT * FROM datasets.visits_v1"

    clickhouse-client clickhouse://clickhouse-01:9000 --query "DROP TABLE datasets.hits_v1"
    clickhouse-client clickhouse://clickhouse-01:9000 --query "DROP TABLE datasets.visits_v1"
else
    clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE DATABASE test"
    clickhouse-client clickhouse://clickhouse-01:9000 --query "SHOW TABLES FROM test"
    if [[ -n "$USE_S3_STORAGE_FOR_MERGE_TREE" ]] && [[ "$USE_S3_STORAGE_FOR_MERGE_TREE" -eq 1 ]]; then
        clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE TABLE test.hits (WatchID UInt64,  JavaEnable UInt8,  Title String,  GoodEvent Int16,
        ...
        clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE TABLE test.visits (CounterID UInt32,  StartDate Date,  Sign Int8,  IsNew UInt8,
        ...
        clickhouse-client clickhouse://clickhouse-01:9000 --max_memory_usage 10G --query "INSERT INTO test.hits SELECT * FROM datasets.hits_v1 SETTINGS enable_filesystem_cache_on_write_operations=0, max_insert_threads=16"
        clickhouse-client clickhouse://clickhouse-01:9000 --max_memory_usage 10G --query "INSERT INTO test.visits SELECT * FROM datasets.visits_v1 SETTINGS enable_filesystem_cache_on_write_operations=0, max_insert_threads=16"
        clickhouse-client clickhouse://clickhouse-01:9000 --query "DROP TABLE datasets.visits_v1 SYNC"
        clickhouse-client clickhouse://clickhouse-01:9000 --query "DROP TABLE datasets.hits_v1 SYNC"
    else
        clickhouse-client clickhouse://clickhouse-01:9000 --query "RENAME TABLE datasets.hits_v1 TO test.hits"
        clickhouse-client clickhouse://clickhouse-01:9000 --query "RENAME TABLE datasets.visits_v1 TO test.visits"
    fi
    clickhouse-client clickhouse://clickhouse-01:9000 --query "CREATE TABLE test.hits_s3  (WatchID UInt64, JavaEnable UInt8, Title String, GoodEvent Int16, EventTime DateTime, EventDate Date, CounterID UInt32, ClientIP UInt32, ClientIP6 FixedString(16), RegionID UInt32, UserID UInt64, CounterClass Int8, OS UInt8, UserAgent UInt8, URL String, Referer String, URLDomain String, RefererDomain String, Refresh UInt8, IsRobot UInt8, RefererCategories Array(UInt16), URLCategories Array(UInt16), URLRegions Array(UInt32), RefererRegions Array(UInt32), ResolutionWidth UInt16, ResolutionHeight UInt16, ResolutionDepth UInt8, FlashMajor UInt8, FlashMinor UInt8, FlashMinor2 String, NetMajor UInt8, NetMinor UInt8, UserAgentMajor UInt16, UserAgentMinor FixedString(2), CookieEnable UInt8, JavascriptEnable UInt8, IsMobile UInt8, MobilePhone UInt8, MobilePhoneModel String, Params String, IPNetworkID UInt32, TraficSourceID Int8, SearchEngineID UInt16, SearchPhrase String, AdvEngineID UInt8, IsArtifical UInt8, WindowClientWidth UInt16, WindowClientHeight UInt16, ClientTimeZone Int16, ClientEventTime DateTime, SilverlightVersion1 UInt8, SilverlightVersion2 UInt8, SilverlightVersion3 UInt32, SilverlightVersion4 UInt16, PageCharset String, CodeVersion UInt32, IsLink UInt8, IsDownload UInt8, IsNotBounce UInt8, FUniqID UInt64, HID UInt32, IsOldCounter UInt8, IsEvent UInt8, IsParameter UInt8, DontCountHits UInt8, WithHash UInt8, HitColor FixedString(1), UTCEventTime DateTime, Age UInt8, Sex UInt8, Income UInt8, Interests UInt16, Robotness UInt8, GeneralInterests Array(UInt16), RemoteIP UInt32, RemoteIP6 FixedString(16), WindowName Int32, OpenerName Int32, HistoryLength Int16, BrowserLanguage FixedString(2), BrowserCountry FixedString(2), SocialNetwork String, SocialAction String, HTTPError UInt16, SendTiming Int32, DNSTiming Int32, ConnectTiming Int32, ResponseStartTiming Int32, ResponseEndTiming Int32, FetchTiming Int32, RedirectTiming Int32, DOMInteractiveTiming Int32, DOMContentLoadedTiming Int32, DOMCompleteTiming Int32, LoadEventStartTiming Int32, LoadEventEndTiming Int32, NSToDOMContentLoadedTiming Int32, FirstPaintTiming Int32, RedirectCount Int8, SocialSourceNetworkID UInt8, SocialSourcePage String, ParamPrice Int64, ParamOrderID String, ParamCurrency FixedString(3), ParamCurrencyID UInt16, GoalsReached Array(UInt32), OpenstatServiceName String, OpenstatCampaignID String, OpenstatAdID String, OpenstatSourceID String, UTMSource String, UTMMedium String, UTMCampaign String, UTMContent String, UTMTerm String, FromTag String, HasGCLID UInt8, RefererHash UInt64, URLHash UInt64, CLID UInt32, YCLID UInt64, ShareService String, ShareURL String, ShareTitle String, ParsedParams Nested(Key1 String, Key2 String, Key3 String, Key4 String, Key5 String, ValueDouble Float64), IslandID FixedString(16), RequestNum UInt32, RequestTry UInt8) ENGINE = MergeTree() PARTITION BY toYYYYMM(EventDate) ORDER BY (CounterID, EventDate, intHash32(UserID)) SAMPLE BY intHash32(UserID) SETTINGS index_granularity = 8192, storage_policy='s3_cache'"
    # AWS S3 is very inefficient, so increase memory even further:
    clickhouse-client clickhouse://clickhouse-01:9000 --max_memory_usage 30G --max_memory_usage_for_user 30G --query "INSERT INTO test.hits_s3 SELECT * FROM test.hits SETTINGS enable_filesystem_cache_on_write_operations=0, max_insert_threads=16"
fi

clickhouse-client clickhouse://clickhouse-01:9000 --query "SHOW TABLES FROM test"
clickhouse-client clickhouse://clickhouse-01:9000 --query "SELECT count() FROM test.hits"
clickhouse-client clickhouse://clickhouse-01:9000 --query "SELECT count() FROM test.visits"
...
/tests/docker_scripts/process_functional_tests_result.py || echo -e "failure\tCannot parse results" > /test_output/check_status.tsv
